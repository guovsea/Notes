...
1. 学生先理解静态路由，自己需要熟悉的一种开发语言
2. 能自动生成一张有代表性的网络拓扑图，包含路由器、交换机、部分主机站点
3. 提供拓扑上主机 IP 地址配置界面，路由器的静态路由的设置
4. 根据设置好的静态路由测试数据包的传输路径是否符合预期等
...
参考：TCP/IP Tutorial and Technical Overview (page 175)
