...
CMake [generators](https://cmake.org/cmake/help/v3.0/manual/cmake-generators.7.html "https://cmake.org/cmake/help/v3.0/manual/cmake-generators.7.html") are responsible for writing the input files (e.g. Makefiles) for the underlying build system. Running `cmake --help` will show the generators available. 
